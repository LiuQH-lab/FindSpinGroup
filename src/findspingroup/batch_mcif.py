...
def _build_group_identifier_payload(result) -> dict:
    return {
        ...
        "sg_is_centrosymmetric": getattr(result, "sg_is_centrosymmetric", None),
        ...
        "ossg_is_centrosymmetric": getattr(result, "ossg_is_centrosymmetric", None),
        ...
        "msg_is_centrosymmetric": getattr(result, "msg_is_centrosymmetric", None),
